...
var Dataset = function() {
    ...
    function Dataset(o) {
        ...
        this.$el = $($.parseHTML(html.dataset.replace("%CLASS%", this.name)));
    }
    ...
    _.mixin(Dataset.prototype, EventEmitter, {
        _render: function render(query, suggestions) {
            ...
            if (!hasSuggestions && this.templates.empty) {
                if(that.templates.header) {
                  this.$el.append(getHeaderHtml());
                }

                this.$el.append(getEmptyHtml());

                if(that.templates.footer) {
                  this.$el.append(getFooterHtml());
                }
                ...
                this.$el.append(getSuggestionsHtml());
            ...
            function getSuggestionsHtml() {
                ...
                $suggestions = $($.parseHTML(html.suggestions)).css(css.suggestions);
                ...
                function getSuggestionNode(suggestion) {
                    ...
                    $el = $($.parseHTML(outerHtml)).data(datasetKey, that.name).data(valueKey, that.displayFn(suggestion)).data(datumKey, suggestion);
...
var Typeahead = function() {
    ...
    function buildDomStructure(input, withHint) {
        ...
        $input = $(input);
        $wrapper = $($.parseHTML(html.wrapper)).css(css.wrapper);
        $dropdown = $($.parseHTML(html.dropdown)).css(css.dropdown);
