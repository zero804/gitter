...
define([], function() {
  ...
  var emojify = (function () {
    ...
    var emoticons = [
      ...
      [/\b(:|;)-*]\b/g, 'smirk'],
      [/\b(:|;)-*d\b/gi, 'smiley'],
      [/\bxd\b/gi, 'stuck_out_tongue_closed_eyes'],
      [/\b:-*p\b/gi, 'stuck_out_tongue_winking_eye'],
      [/\b:-*(\[|@)\b/g, 'rage'],
      [/\b:-*\(\b/g, 'disappointed'],
      [/\b:(\'|\’)-*\(\b/g, 'sob'],
      [/\b:-*\*\b/g, 'kissing_heart'],
      ...
      [/\b:-*x\b/gi, 'mask'],
      [/\b<3\b/g, 'heart'],
      [/\b<\/3\b/g, 'broken_heart'],
      [/:\+1:/g, 'thumbsup'],
      [/:\-1:/g, 'thumbsdown'],
    ];

    var sets = [].concat(emoticons, set2);
