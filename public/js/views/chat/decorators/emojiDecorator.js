...
define([], function() {
    ...
    var emojify = (function () {
        ...
        var emoticons = [
            [/(^|\W):-*\)/g, 'emojify blush'],
            [/(^|\W):-*o/gi, 'emojify scream'],
            [/(^|\W)(:|;)-*]/g, 'emojify smirk'],
            [/(^|\W)(:|;)-*d/gi, 'emojify smiley'],
            [/(^|\W)xd/gi, 'emojify stuck_out_tongue_closed_eyes'],
            [/(^|\W):-*p/gi, 'emojify stuck_out_tongue_winking_eye'],
            [/(^|\W):-*(\[|@)/g, 'emojify rage'],
            [/(^|\W):-*\(/g, 'emojify disappointed'],
            [/(^|\W):('|’)-*\(/g, 'emojify sob'],
            [/(^|\W):-*\*/g, 'emojify kissing_heart'],
            [/(^|\W);-*\)/g, 'emojify wink'],
            [/(^|\W):-*\//g, 'emojify pensive'],
            [/(^|\W):-*s/gi, 'emojify confounded'],
            [/(^|\W):-*\|/g, 'emojify flushed'],
            [/(^|\W):-*\$/g, 'emojify relaxed'],
            [/(^|\W):-*x/gi, 'emojify mask'],
            [/(^|\W)<3/g, 'emojify heart'],
            [/(^|\W)<\/3/g, 'emojify broken_heart']
        ],
            people = [
