...
define([], function() {
  ...
  var emojify = (function () {
    ...
    var emoticons = [
      ...
      [/(^|\W)(:|;)-*]/g, 'smirk'],
      [/(^|\W)(:|;)-*d/gi, 'smiley'],
      [/(^|\W)xd/gi, 'stuck_out_tongue_closed_eyes'],
      [/(^|\W):-*p/gi, 'stuck_out_tongue_winking_eye'],
      [/(^|\W):-*(\[|@)/g, 'rage'],
      [/(^|\W):-*\(/g, 'disappointed'],
      [/(^|\W):('|’)-*\(/g, 'sob'],
      [/(^|\W):-*\*/g, 'kissing_heart'],
    ...
    return {
      ...
      run: function (el) {              
        ...
        var sets = [].concat(people, nature, objects, places, symbols, emoticons);
