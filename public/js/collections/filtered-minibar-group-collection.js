...
var FilteredMinibarGroupCollection = SimpleFilteredCollection.extend({
  ...
  initialize: function(models, options) {
    ...
    this.listenTo(
      this.dndCtrl,
      'minibar:update-favourite-group',
      this.onUpdateFavouriteGroup,
      this
    );
    this.listenTo(
      this.dndCtrl,
      'minibar:remove-favourite-group',
      this.onRemoveFavouriteGroup,
      this
    );
  },
  ...
  onUpdateFavouriteGroup: function(id, type, siblingID) {
    ...
    var group;
    if (type === 'group' || type === 'minibar-group' || type === 'room-list-group') {
