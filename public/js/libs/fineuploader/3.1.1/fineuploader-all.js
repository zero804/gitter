...
define(['jquery'], function($) { /*jslint browser: true*/
  ...
  qq.isXhrUploadSupported = function() {
    ...
    return(
    input.multiple !== undefined && typeof File !== "undefined" && typeof FormData !== "undefined" && typeof(new XMLHttpRequest()).upload !== "undefined");
  };
  ...
  qq.DisposeSupport = function() {
    ...
    return { /** Run all registered disposers */
      dispose: function() {
        var disposer;
        do {
      ...
      attach: function() {
        var args = arguments; /*jslint undef:true*/
  ...
  qq.DragAndDrop = function(o) {
    ...
    var options, dz, dirPending, droppedFiles = [],
