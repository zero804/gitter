...
Faye.Client = Faye.Class({
  ...
  initialize: function(endpoint, options) {
    ...
    if(this._options.prenegotiatedConnection) {
      var pre = this._options.prenegotiatedConnection;
      this._state     = this.CONNECTED;
      this._channels  = new Faye.Channel.Set();
      this._messageId = 100;
      this._clientId  = pre.clientId;
    ...
    if(this._options.prenegotiatedConnection) {
      this._selectTransport(this._options.prenegotiatedConnection.supportedConnectionTypes);
    }
  },
