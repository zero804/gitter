...
define([
  ...
  if(!window.troupeTrackingId) {
    return {
      trackError: function(message, file, line) { if (console) console.log("An unexpected error occurred: '" + message + "' in " + file  + ":" + line, arguments); }
    };
  }
  ...
  if (console) console.log("Clearing the hash");
  _gaq.push(function() {

    window.setTimeout(function() {
      if (console) console.log("Callback from GAQ");
