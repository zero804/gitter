...
module.exports = function getSnapshotsForPageContext(req, troupeContext, rooms, hasGroups) {
  ...
  var minibarOrgList = !!hasGroups ? [] : suggestedOrgsFromRoomList(rooms, req.uriContext.uri, currentRoomId, currentRoom);
