...
GitHubOrgService.prototype.getOrg = function(org) {
  return tentacles.org.get(org, { accessToken: this.accessToken });
};
...
GitHubOrgService.prototype.members = function(org) {
  return tentacles.orgMember.listMembers(org, { accessToken: this.accessToken });
};

GitHubOrgService.prototype.member = function(org, username) {
  return tentacles.orgMember.checkMembershipForUser(org, username, { accessToken: this.accessToken });
};

GitHubOrgService.prototype.getRepos = function(org) {
  return tentacles.repo.listForOrg(org, { accessToken: this.accessToken });
};

GitHubOrgService.prototype.getMembership = function(org, username) {
  return tentacles.orgMember.getMembershipForUser(org, username, { accessToken: this.accessToken });
};
