...
module.exports = {
  ...
  show: function(req, res, next) {
    ...
    restSerializer.serialize(req.userInvite, strategy, function(err, serialized) {
      if(err) return next(err);
  ...
  update:  function(req, res){
    // accept invite
    inviteService.acceptInviteForAuthenticatedUser(req.user, req.userInvite)
  ...
  destroy: function(req, res) {
    // reject invite
    inviteService.rejectInviteForAuthenticatedUser(req.user, req.userInvite)
      .then(function() {
