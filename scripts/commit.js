...
updateFileAndCreatePullRequest('gitterHQ/mutant.js', 'suprememoocow', 'master', 'gitter-badge', '[![Gitter chat](https://badges.gitter.im/gitterHQ/mutant.js.png)](https://gitter.im/gitterHQ/mutant.js)')
  .then(function(pr) {
    console.log(pr);
  })
  .fail(function(err) {
