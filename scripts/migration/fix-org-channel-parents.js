...
function dryRun() {
  return getUpdates()
    .then(function(updates) {
      console.log(cliff.stringifyObjectRows(updates, ['_id', 'uri', 'originalParentId', 'originalOwnerUserId', 'correctUri', 'correctParentId', 'correctParentUri', 'correctLcOwner', 'userCount']));
    });
}
