...
describe('user-group-favourites-export-api', function() {
  ...
  it('GET /api_web/export/user/:user_id/user-group-favourites.ndjson as same user gets data', async () => {
    ...
    return request(app)
      .get(`/api_web/export/user/${fixture.user1.id}/user-group-favourites.ndjson`)
