...
def driver():
    ...
    elif driverName == 'REMOTEMOBSAFARI':
        print('Using remote mobile safari')
        driver = webdriver.Remote(command_executor=remote, desired_capabilities={"CFBundleName": "Safari",
                                                                                 "device": "iphone",
                                                                                 "language": "en",
                                                                                 #"locale": "en_gb",
                                                                                 "variation": "Regular",
