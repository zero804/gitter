  ...
  describe('#slow', function() {
    ...
    describe('getSetting', function() {
      it('should handle null values', function() {
        ...
        assert(user2);
        return userSettingsMuxer.getSetting(user2, 'lang')
    ...
    describe('getSettings', function() {
      it('should handle multiple values', function() {
        var user2 = fixture.user2;
        assert(user2);
        return userSettingsMuxer.getSettings(user2, ['lang', 'defaultRoomMode'])
          .then(function(result) {
    ...
    describe('updateSetting', function() {
      it('should handle updates', function() {
        ...
        assert(user1);
        return userSettingsMuxer.updateSetting(user1, 'lang', 'en')
          .then(function(result) {
      ...
      it('should handle updates', function() {
        ...
        return userSettingsMuxer.updateSettings(user1, {
          ...
          .then(function(result) {
            ...
            return userSettingsMuxer.getSettings(user1, ['lang', 'defaultRoomMode', 'leftRoomMenu', 'unread_notifications_optout']);
          })
          .then(function(result) {
            assert.strictEqual(result.lang, 'fr');
            assert.strictEqual(result.defaultRoomMode.mode, 'all');
