  ...
  describe('integration tests #slow', function() {
    ...
    describe('findUsersWithDevices', function() {
      ...
      it('should prune unused old devices', function() {
        ...
        return pushNotificationService.registerDevice('DEVICE1', 'TEST', token, 'TESTDEVICE', '1.0.1', '122')
          .then(function() {
      ...
      it('should findEnabledDevicesForUsers', function() {
        ...
        return pushNotificationService.registerAndroidDevice(deviceId, 'Android', registrationId, '1.0', userId)
          .then(function() {
          ...
          .then(function(devices) {
            ...
            return pushNotificationService.findEnabledDevicesForUsers([userId], { supportsBadges: true })
          })
          .then(function(devices) {
