...
makeBenchmark({
  ...
  tests: {
    ...
    'newItemWithNoMentions small room, one mention': function(done) {
      unreadItemsServiceEngine.newItemWithMentions(mongoUtils.getNewObjectIdString(), mongoUtils.getNewObjectIdString(), smallUserSet, smallUserSetSingleMention)
        .nodeify(done);
    },

    'newItemWithNoMentions small room, many mentions': function(done) {
      unreadItemsServiceEngine.newItemWithMentions(mongoUtils.getNewObjectIdString(), mongoUtils.getNewObjectIdString(), smallUserSet, smallUserSetManyMentions)
        .nodeify(done);
    },

    'newItemWithNoMentions large room, no mentions': function(done) {
      unreadItemsServiceEngine.newItemWithMentions(mongoUtils.getNewObjectIdString(), mongoUtils.getNewObjectIdString(), largeUserSet, [])
        .nodeify(done);
    },

    'newItemWithNoMentions large room, one mention': function(done) {
      unreadItemsServiceEngine.newItemWithMentions(mongoUtils.getNewObjectIdString(), mongoUtils.getNewObjectIdString(), largeUserSet, largeUserSetSingleMention)
        .nodeify(done);
    },

    'newItemWithNoMentions large room, many mentions': function(done) {
      unreadItemsServiceEngine.newItemWithMentions(mongoUtils.getNewObjectIdString(), mongoUtils.getNewObjectIdString(), largeUserSet, largeUserSetManyMentions)
        .nodeify(done);
    },
