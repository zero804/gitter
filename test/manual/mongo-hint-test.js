...
speedy.run({
  ...
  withHintLatest: function(done) {
    ...
    chatService.findChatMessagesForTroupe('54d244f1c53660e29b9f91d9', {}).nodeify(done);
  },
  ...
  firstMessageInRoom: function(done) {
    chatService.getDateOfFirstMessageInRoom('54d244f1c53660e29b9f91d9').nodeify(done);
  }
});
