...
describe('presenceService', function () {
  ...
  it('should cleanup invalid sockets correctly', function () {
    return presenceService.listOnlineUsers()
      .then(function (users) {
        var noTestUsersOnline = users.length === 0 || users.every(function (id) {
  ...
  it('users presence should appear and disappear as expected', function () {
    ...
    return presenceService.findOnlineUsersForTroupe(troupeId)
      .then(function (users) {
        ...
        assert(users.length === 0 || users.every(function (id) {
          return id !== userId;
        }), 'Expected user _not_ to be online at beginning of test: ', users.join(', '));
        ...
        return presenceService.userSocketConnected(userId, socketId, 'online', 'test', 'faye', troupeId, null, null, true)
          .then(function () {
            ...
            return presenceService.lookupUserIdForSocket(socketId)
                  ...
                  .then(function (users) {
                    ...
                    return presenceService.socketDisconnected(socketId)
                      .then(function () {
                        ...
                        return presenceService.findOnlineUsersForTroupe(troupeId)
                          .then(function (users) {
                            var notThere = (!users.length || users.every(function (id) {
                              return id !== userId;
                            }));
  ...
  it('users presence should remain offline if they subscribe to a troupe while offline', function () {
    ...
    return presenceService.findOnlineUsersForTroupe(troupeId)
      .then(function (users) {
        ...
        // Connect the socket
        return presenceService.userSocketConnected(userId, socketId, 'online', 'test', 'faye', troupeId, null, null, false);
      })
      .then(function () {
        // Make sure that the user appears online
        return presenceService.findOnlineUsersForTroupe(troupeId);
      ...
      return presenceService.findOnlineUsersForTroupe(troupeId)
        .then(function (users) {
          if (inTroupe) {
            ...
            assert(users.every(function (id) {
              return id !== userId;
  ...
  it('should show mobile users in a troupe as in the troupe', function () {
    ...
    return presenceService.userSocketConnected(userId, socketId, 'mobile', 'test', 'faye', troupeId, null, null, true)
      .then(function () {
  ...
  it('should handle users who are online and mobile concurrently correctly', function () {
    ...
    return presenceService.userSocketConnected(userId, socketId1, 'mobile', 'test', 'faye', troupeId, null, null, true)
      .then(function () {
        return ensureUserTroupeStatus(true);
      })
      .then(function () {
        return presenceService.userSocketConnected(userId, socketId2, 'online', 'test', 'faye', troupeId, true, null, null);
      })
      .then(function () {
  ...
  it('should correct sockets for multiple users', function () {
    ...
    return presenceService.userSocketConnected(userId1, socketId1, 'online', 'test', 'faye', null, null, null, null)
      .then(function () {
        return presenceService.userSocketConnected(userId2, socketId2, 'mobile', 'test', 'faye', null, null, null, null);
      })
      .then(function () {
        // Now mess things up intentionally
  ...
  it('should correctly categorize users who are online and offline', function () {
    ...
    return presenceService.userSocketConnected(userId1, socketId1, 'online', 'test', 'faye', null, null, null, null)
      .then(function () {
        return presenceService.userSocketConnected(userId2, socketId2, 'online', 'test', 'faye', null, null, null, null);
      })
      .then(function () {
  ...
  it('should correctly categorize userstroupe who are introupe, online and offline', function () {
    ...
    return presenceService.userSocketConnected(userId1, socketId1, 'online', 'test', 'faye', troupeId, null, null, true)
      .then(function () {
