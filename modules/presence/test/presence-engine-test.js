...
describe('presenceService', function() {
  ...
  it('should allow a user to connect', function(done) {
    ...
    presenceService.userSocketConnected(userId, socketId, 'online', 'test', null, null, null, function(err) {
      if(err) return done(err);
  ...
  it('users presence should appear and disappear as expected', function(done) {
    ...
    var oauthClientId = 'TESTCLIENTID1' + Date.now();
    ...
    presenceService.findOnlineUsersForTroupe(troupeId, function(err, users) {
      ...
      // Connect the socket
      presenceService.userSocketConnected(userId, socketId, 'online', 'test', troupeId, oauthClientId, true, function(err) {
        if(err) return done(err);
  ...
  it('users presence should remain offline if they subscribe to a troupe while offline', function(done) {
    ...
    presenceService.findOnlineUsersForTroupe(troupeId, function(err, users) {
      ...
      // Connect the socket
      presenceService.userSocketConnected(userId, socketId, 'online', 'test', troupeId, oauthClientId, false, function(err) {
        if(err) return done(err);
  ...
  it('should handle very quick connect/disconnect cycles when the user connects to a troupe', function(done) {
    ...
    var oauthClientId = 'TESTCLIENTID2' + Date.now();
  ...
  it('should handle eye-balls-on, eyes-balls-off', function(done) {
    ...
    var oauthClientId = 'TESTCLIENTID3' + Date.now();
  ...
  it('should handle incorrect eyeball signals', function(done) {
    ...
    var oauthClientId = 'TESTCLIENTID4' + Date.now();
  ...
  it('should not show mobile users as online', function(done) {
    ...
    presenceService.userSocketConnected(userId, socketId, 'mobile', 'test', null, null, null, function(err) {
      if(err) return done(err);
  ...
  it('should categorise mobile users as mobile', function(done) {
    ...
    presenceService.userSocketConnected(userId, socketId, 'mobile', 'test', null, null, null)
      .then(function() {
  ...
  it('should show mobile users in a troupe as in the troupe', function(done) {
    ...
    presenceService.userSocketConnected(userId, socketId, 'mobile', 'test', troupeId, oauthClientId, true, function(err) {
      if(err) return done(err);
  ...
  it('should handle users who are online and mobile concurrently correctly', function(done) {
    ...
    presenceService.userSocketConnected(userId, socketId1, 'mobile', 'test', troupeId, oauthClientId, true, function(err) {
      if(err) return done(err);

      ensureUserTroupeStatus(true, function() {

        presenceService.userSocketConnected(userId, socketId2, 'online', 'test', troupeId, true, oauthClientId, function(err) {
          if(err) return done(err);
  ...
  it('should correct sockets for multiple users', function(done) {
    ...
    presenceService.userSocketConnected(userId1, socketId1, 'online', 'test', null, null, null, function(err) {
      presenceService.userSocketConnected(userId2, socketId2, 'mobile', 'test', null, null, null, function(err) {
        if(err) return done(err);
  ...
  it('should correctly categorize users who are online and offline', function(done) {
    ...
    presenceService.userSocketConnected(userId1, socketId1, 'online', 'test', null, null, null, function(err) {
      ...
      presenceService.userSocketConnected(userId2, socketId2, 'online', 'test', null, null, null, function(err) {
        if(err) return done(err);
  ...
  it('should correctly categorize userstroupe who are introupe, online and offline', function(done) {
    ...
    presenceService.userSocketConnected(userId1, socketId1, 'online', 'test', troupeId, oauthClientId, true, function(err) {
      if(err) return done(err);

      presenceService.userSocketConnected(userId2, socketId2, 'online', 'test', null, oauthClientId, null, function(err) {
        if(err) return done(err);
  ...
  describe('socketReassociated', function() {
    var userId, socketId, troupeId, troupeId2, oauthClientId, presenceChangeMock, eyeballSignalMock;
    ...
    beforeEach(function() {
      ...
      oauthClientId = 'TESTCLIENTID1' + Date.now();
    ...
    describe('non-anonymous', function() {
      ...
      it('should reassociate a socket correctly', function(done) {
        return presenceService.userSocketConnected(userId, socketId, 'online', 'test', troupeId, oauthClientId, true)
          .then(function() {
      ...
      it('should reassociate a socket when previously there was no socket', function(done) {
        return presenceService.userSocketConnected(userId, socketId, 'online', 'test', null, oauthClientId, true)
          .then(function() {
            // Validate user is in troupe1
            return presenceService.listOnlineUsersForTroupes([troupeId]);
          })
    ...
    describe('anonymous', function() {
      ...
      it('should reassociate a socket correctly', function(done) {
        return presenceService.userSocketConnected(null, socketId, 'online', 'test', troupeId, oauthClientId, true)
          .then(function() {
      ...
      it('should reassociate a socket when previously there was no socket', function(done) {
        return presenceService.userSocketConnected(null, socketId, 'online', 'test', null, oauthClientId, true)
          .then(function() {
            mockito.verify(presenceChangeMock, never())(null, anything(), anything());
