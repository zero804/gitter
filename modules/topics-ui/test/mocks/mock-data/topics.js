...
module.exports = [
  ...
  { title: '4', id: '4', slug: '4', name: '4', body: { html: 'test'}, category: "test", tags: [], user: { displayName: 'test-user', avatarUrl: 'test-src'}},
  { title: '5', id: '5', slug: '5', name: '5', body: { html: 'test'}, category: "test", tags: [], user: { displayName: 'test-user', avatarUrl: 'test-src'}},
];
